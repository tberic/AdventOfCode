# We are having problems when there are multiple blocks that have the same maxCount
# This program is good for determining the max number of cubes which have our point in the intersection
# maxIntersect = 977
# now switch to 2-2.py
